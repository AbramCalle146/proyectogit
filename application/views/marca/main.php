    ...
    <div class="header-body">
      <div class="row align-items-center py-4">
        ...
        <div class="col-lg-6 col-5 text-right">
          <a href="<?php echo base_url(); ?>nuevo-marca" class="btn btn-secondary">Nuevo</a>
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="col">
      <div class="card">
        ...
        <div class="card-header border-0" style="background-color: transparent;">
             <h3 class="mb-0" style="font-size: 2rem;">Lista</h3>
            </div>
        <!-- Light table -->
        <div class="table-responsive">
          <table id="marcaTable" class="table align-items-center table-flush">
                  ...
                  <td class="text-right">
                    <div class="dropdown">
                      ...
                      <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                        <a class="dropdown-item" href="<?php echo base_url()."marca/".$value->id; ?>">Editar</a>
                        <a class="dropdown-item" href="<?php echo base_url()."marca/delete/".$value->id; ?>">Eliminar</a>
                      </div>
                    </div>
                  </td>
                </tr>
